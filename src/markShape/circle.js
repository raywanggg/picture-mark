...
const circle = function() {
    ...
    //建立新画布
    var cirCan = addCanvas();
    var circxt = cirCan.getContext("2d");

    var circleCreate = (x,y,a,b,n) => {//xy为圆心
